...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <h3 class="text-lg font-medium mb-4">Voir le Calendrier</h3>
            <p class="text-gray-500 mb-4">
                Consultez votre calendrier pour voir les prochaines échéances et réunions.
            </p>
            <a href="{{ route('stagiaire.calendrier') }}" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
